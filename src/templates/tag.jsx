...
const Tag = ({ pageContext }) => {
  const { posts, tagName, typePath, target  } = pageContext;
  ...
  return (
    <Layout>
      ...
      <Container>
        <ContentNav path="/category" title="分类" keyword={tagName}></ContentNav>
        {posts.map(post => (
          <Wrapper key={post.id}>
            <Information>
              <HeadTitle>
              ...
              <ContentHeader name={tagName} tags={post.frontmatter.tags} path={post.frontmatter.path}></ContentHeader>
              {post.excerpt}
